...
const Nav = styled.nav`
  ...
  padding: 5px 10px;
  z-index: 5;
  border-bottom: 3px solid ${(props) => props.theme.navbarBottomBorderColor};
  ...
  .navbar-section1 {
    ...
    .searchbar {
      ...
      .search-icon {
        ...
        filter: ${(props) => props.theme.navbarSearchIcon};
      }
      input {
        background: none;
        outline: none;
        border: none;
        color: ${(props) => props.theme.feedBackgroundColor};
        font-size: 0.9375rem;
        font-family: inherit;
  ...
  .navbar-section2 {
    ...
    .icon {
      ...
      &:hover {
        background: ${(props) => props.theme.navbarIconBackgroundSection2Hover};
        .tooltip-box {
          opacity: 1;
          visibility: visible;
        }
    ...
    svg {
      cursor: pointer;
      fill: ${(props) => props.theme.navbarIconSection2};
    }
  ...
  .navbar-section3 {
    ...
    .item {
      position: relative;
      background-color: ${(props) => props.theme.navbarIconSection3Background};
      width: 40px;
      height: 40px;
      margin-right: 8px;
      display: flex;
      ...
      &:hover {
        background-color: ${(props) =>
          props.theme.navbarIconBackgroundSection3Hover};
        .tooltip-box {
          opacity: 1;
          visibility: visible;
        }
      ...
      svg {
        fill: ${(props) => props.theme.navbarIconSection3IconSVG};
      }
    }
    .profile {
      display: flex;
      ...
      &:hover {
        background-color: ${(props) =>
          props.theme.navbarIconSection3Background};
      }
      .thumbnail {
        width: 28px;
        height: 28px;
    ...
    .create {
      .wrap-create {
        ...
        background-repeat: no-repeat;
        display: inline-block;
        filter: ${(props) => props.theme.navbarIconSection3Icon};
      }
    }
    .account {
      .wrap-account {
